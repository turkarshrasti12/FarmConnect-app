...
const LocationMap: React.FC<LocationMapProps> = ({ onRegionSelect, language, t }) => {
  ...
  return (
    <div className="h-[400px] w-full rounded-2xl overflow-hidden border-2 border-emerald-100 shadow-inner relative z-0">
      <MapContainer 
      ...
      <div className="absolute bottom-4 left-4 z-[1000] bg-white/90 backdrop-blur p-2 rounded-lg shadow-sm text-[10px] font-bold text-emerald-800 border border-emerald-100">
